name: GH-Readme-Builder-AutoDEV
description: |
  Agente especializado para desarrollo y mantenimiento de GH-Readme-Builder - 
  Herramienta web para construcción visual de archivos README.md para GitHub
version: 1.0.0
enabled: true

instructions: |
  # Agente GH-Readme-Builder - Especialista en Desarrollo
